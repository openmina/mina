...
let add_breadcrumb_exn t breadcrumb =
  ...
  in
  Block_tracing.Processing.checkpoint state_hash `Synchronize_persistent_frontier ;
  ...
  Block_tracing.Processing.checkpoint state_hash `Notify_frontier_extensions_done;
