                  ...
                  ~f:(fun { Impls.Step.Proof_inputs.auxiliary_inputs
                    ...
                    let (_ : unit) =
                      ...
                      .push_global
                        ~time:
                          (float_of_string
                             meta.z_permutation_aggregation_polynomial )
                    ...
                    let (_ : unit) =
                      ...
                      .push_global
                        ~time:
                          (float_of_string
                             meta.eval_witness_polynomials_over_domains )
                    ...
                    let (_ : unit) =
                      ...
                      .push_global
                        ~time:
                          (float_of_string meta.lagrange_basis_eval_zeta_poly)
                    ...
                    let (_ : unit) =
                      ...
                      .push_global
                        ~time:
                          (float_of_string
                             meta.lagrange_basis_eval_zeta_omega_poly )
                    ...
                    let (_ : unit) =
                      ...
                      .push_global
                        ~time:
                          (float_of_string
                             meta.create_aggregated_evaluation_proof )
